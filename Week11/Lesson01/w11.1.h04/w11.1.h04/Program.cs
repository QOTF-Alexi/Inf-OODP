...
static class Program
{
    static void Main(string[] args)
    {
        switch (args[1])
        {
            ...
            case "ISelectable": TestISelectable(); return;
            case "Implement": TestImplementation(); return;
            case "TowerWhere": TestTowerWhereClause(); return;
            case "BuildWhere": TestBuildWhereClause(); return;
            case "Circle": TestCircle(); return;
            case "Square": TestSquare(); return;
            case "Tower": TestTower(); return;
            case "Builder": TestTowerBuilder(); return;
    ...
    public static void TestTower()
    {
        ...
        {
            Console.WriteLine("Shape count in this tower: "
                + tower.Index);
        }
    }
    ...
    private static bool HasMethodSignature(Type interfaceType, string methodName, Type returnType, Type[] parameterTypes)
    {
