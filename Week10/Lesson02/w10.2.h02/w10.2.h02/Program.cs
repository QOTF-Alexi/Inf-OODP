static class Program
{
    static void Main(string[] args)
    {
        switch (args[1])
        {
            case "Sort": TestSort(); return;
            case "Equal": TestEqual(); return;
            case "Enumerable": TestEnumerable(); return;
    ...
    public static void TestEqual()
    {
        ...
        SavingsAccount acc5 = new SavingsAccount { AccountNumber = 101, AccountHolderName = "John Doe", Balance = 1000 };
        SavingsAccount acc6 = new SavingsAccount { AccountNumber = 101, AccountHolderName = "John Doe", Balance = 2000 };
        CreditCardAccount acc7 = new CreditCardAccount { AccountNumber = 101, AccountHolderName = "John Doe", Balance = 1000 };
        Account acc8 = null;
        Account acc9 = null;
